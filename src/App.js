...
export default function App() {
  ...
  // const [watched, setWatched] = useState([]); i changed this into lazy intial state
  ...
  // useEffect(function () {
  //   fetch(`http://www.omdbapi.com/?apikey=${omdbApiKey}&s=${query}`)
  //     .then((res) => res.json())
  ...
  return (
    <>
      ...
      <Main>
        {/* <Box element={loader ? <Loader /> : <MovieList movies={movies} />} /> */}
